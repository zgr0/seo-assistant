    ...
    public void Configure(EntityTypeBuilder<Rule> b)
    {
        b.HasData(
            ...
            R("REDIRECT_TARGET_INVALID", RuleCategory.Indexability, Severity.Critical, 9,
                ...
                "Yonlendirme http/https disi bir adrese gidiyor; hicbir istemci hedefe ulasamaz.",
                "Location basligini gercek bir URL'e cevir ya da yonlendirmeyi kaldir."),
            ...
            R("INVALID_STRUCTURED_DATA", RuleCategory.StructuredData, Severity.Medium, 4,
                ...
                "Sayfada JSON-LD var ama bicimi bozuk; arama motorlari okuyamaz.",
                "Her kok nesneyi ayri bir <script type=\"application/ld+json\"> icine koy, JSON'u dogrula."),
