...
namespace SeoCopilot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908072758_EnrichRuleTexts")]
    partial class EnrichRuleTexts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SeoCopilot.Domain.Entities.Rules.Rule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Category = "indexability",
                            DescriptionTr = "Sayfa 5xx donuyor ya da hic getirilemedi (baglanti hatasi, zaman asimi). Bu sunucu kaynakli bir arizadir; arama motoru 5xx gorunce once tarama hizini dusurur, hata surerse sayfayi dizinden cikarir. 4xx'ten daha acildir, cunku sorun cogu zaman tek sayfada degil altyapinin tamaminda olur. Planli bakim aninda alinan olcum ise yanlis pozitif olabilir — dogru davranis o sirada 503 donmektir.",
                            DocUrl = "https://developers.google.com/search/docs/crawling-indexing/http-network-errors",
                        ...
                        new
                        {
                            ...
                            Category = "indexability",
                            DescriptionTr = "Dizinlenebilir bir sayfa sitemap'te listelenmiyor. Sitemap disindaki sayfa yine bulunabilir, ama kesfi tamamen ic linklere kalir; yeni yayinlanan iceriklerde bu gecikme gunlere yayilabilir. Ayrica sitemap kapsami ile gercek sayfa listesi arasindaki fark, Search Console raporlarini okumayi zorlastirir. Dizine girmemesi gereken sayfalar icin dogru cozum sitemap'e eklemek degil noindex vermektir.",
                        ...
                        new
                        {
                            ...
                            Category = "meta",
                            DescriptionTr = "Title 30 karakterden kisa. Kisa basliklar sayfanin ne sundugunu anlatmaya yetmez, arama sonucunda tiklama oranini dusurur ve kelime cesitliligi olmadigi icin daha az sorguyla eslesir. Teknik bir hata degil, kacirilmis bir firsattir. Yalnizca marka ana sayfasi gibi tek kelimenin yeterli oldugu yerlerde kabul edilebilir.",
                            DocUrl = "https://developers.google.com/search/docs/appearance/title-link",
                        ...
                        new
                        {
                            ...
                            Category = "meta",
                            DescriptionTr = "Meta description 160 karakterden uzun. Fazlasi arama sonucunda uc noktayla kesilir ve sonda kalan eylem cagrisi kullaniciya hic gorunmez. Uzun aciklama ceza almaz, sadece etkisiz kalir. Gorunen sinir dile ve cihaza gore degistigi icin hedef karakter sayisini biraz altta tutmak guvenlidir.",
                            DocUrl = "https://developers.google.com/search/docs/appearance/snippet",
                        ...
                        new
                        {
                            ...
                            Category = "links",
                            DescriptionTr = "Bir ic link 4xx/5xx donen sayfaya gidiyor. Kullanici akisin ortasinda hata sayfasina duser; tarama acisindan da bosa harcanan bir istek olur ve linkle aktarilacak deger kaybolur. Kirik ic link cogunlukla yeniden yapilandirma, silinen urun veya elle yazilmis yanlis adresten kaynaklanir. Bilincli olarak 404 birakilan adresler varsa cozum onlara link vermemektir.",
                        ...
                        new
                        {
                            Code = "ORPHAN_PAGE",
                            Category = "links",
                            DescriptionTr = "Sayfaya hicbir ic link isaret etmiyor. Ic link olmadan sayfa yalnizca sitemap veya dis linklerle bulunabilir; kesfi yavaslar ve site icindeki onem sinyali sifira yakin kalir. Kullanici da menuden ya da icerik icinden bu sayfaya ulasamaz. Kampanya acilis sayfalari gibi bilincli olarak menu disinda tutulan adreslerde beklenen durumdur.",
                            DocUrl = "https://developers.google.com/search/docs/crawling-indexing/links-crawlable",
